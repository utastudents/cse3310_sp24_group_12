 ...
 * return CheckLine(0, 1, 2, player) || CheckLine(3, 4, 5, player) ||
 * CheckLine(6, 7, 8, player);
 * }
 * 
 * private boolean CheckVertical(PlayerType player) {
 * return CheckLine(0, 3, 6, player) || CheckLine(1, 4, 7, player) ||
 * CheckLine(2, 5, 8, player);
 * }
 * 
 ...
 * 
 * if ((CurrentTurn == U.PlayerIdx) && (CurrentTurn == PlayerType.OPLAYER ||
 * CurrentTurn == PlayerType.XPLAYER)) {
